...
export default function App() {
  ...
  const router = createBrowserRouter([
    ...
    children:[
      {index:true, element: <Home webTopicsData = {webTopicsData} setWebTopicsData={setWebTopicsData} selectRef={selectRef} inputRef={inputRef} filterCategory={filterCategory} setFilterCategory={setFilterCategory} searchAPIArray={searchAPIArray} setSearchAPIArray={setSearchAPIArray} setAllFilters={setAllFilters} allFilters={allFilters} sortRef={sortRef} />},
